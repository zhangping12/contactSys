...
public class ContactOperatorImpl implements ContactOperator{
    ...
    public void addContact(Contact contact) {
        try {
            ...
            contactElem.addElement("name",contact.getName());
            contactElem.addElement("gender",contact.getGender());
            contactElem.addElement("age",contact.getAge()+"");//int转string，直接后面添加个空的字符串
            contactElem.addElement("phone",contact.getPhone());
            contactElem.addElement("email",contact.getEmail());
            contactElem.addElement("qq",contact.getQq());
